		...
		>
			<ul className={'flex justify-between items-center flex-1 px-4 md:px-16'}>
				<li className="">
					<Bars3CenterLeftIcon
						className={
							'h-8 w-8 cursor-pointer text-gray-700 hover:text-dark-500 transition-colors ease-in-out duration-300'
						}
				...
				<li className="flex items-center gap-5 md:gap-8">
						...
						>
							...
							>
								<div className="flex justify-between items-center">
									<p className="text-gray-700 font-bold">Notificaciones</p>
									<button className="text-sm font-medium text-dark-500 bg-transparent py-1 px-2 border border-primary rounded shadow transition-colors ease-in-out duration-300 hover:bg-gray-200">
										Marcar como leido
									</button>
								</div>
					...
					<Menu as={'div'} className={'relative inline-block text-left'}>
						...
						>
							...
							/>
							<span className="hidden md:block font-medium text-gray-700">Usuario</span>
							...
							>
								<Menu.Item>
									<Link
										href={'#'}
										className={
											'flex hover:bg-primary hover:text-white text-gray-700 rounded p-2 text-sm transition-colors ease-in-out duration-300 items-center gap-2'
										}
									>
